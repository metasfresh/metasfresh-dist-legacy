...
<code>currentBuild.displayname</code> and <code>currentBuild.description</code> to make it obvious that the build contains code from the feature branch.''',
		...
		string(defaultValue: 'secondary_opinion_LATEST',
...
""";
	...
	stage('Build&Push docker images')
	{
		...
		echo="params.MF_METASFRESH_REPORT_DOCKER_BASE_IMAGE_VERSION=${params.MF_METASFRESH_REPORT_DOCKER_BASE_IMAGE_VERSION}"
		final String reportDockerBaseImageTag = misc.mkDockerTag("${params.MF_METASFRESH_REPORT_DOCKER_BASE_IMAGE_VERSION}")
		echo="reportDockerBaseImageTag=${reportDockerBaseImageTag}"
